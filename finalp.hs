...
main = do
  print (test1)
  --   good then bad case
  let testCases = [Num 1, Num (-1), Boolean True, Boolean False, Id "x", Plus (Num 1) (Num 2), Plus (Num 2) (Num 1), Minus (Num 1) (Num 2), Minus (Num 2) (Num 1), Mult (Num 1) (Num 2), Mult (Num 2) (Num 1), Div (Num 1) (Num 2), Div (Num 2) (Num 1), Exp (Num 1) (Num 2), Exp (Num 2) (Num 1), Between (Num 1) (Num 2) (Num 3), Between (Num 2) (Num 1) (Num 3), Between (Num 2) (Num 3) (Num 1), Lambda "x" TNum (Id "x"), Lambda "x" TNum (Num 1), App (Lambda "x" TNum (Id "x")) (Num 1), App (Lambda "x" TNum (Num 1)) (Num 1), Bind "x" (Num 1) (Id "x"), Bind "x" (Num 1) (Num 1), If (Boolean True) (Num 1) (Num 2), If (Boolean False) (Num 1) (Num 2), And (Boolean True) (Boolean True), And (Boolean True) (Boolean False), Or (Boolean True) (Boolean True), Or (Boolean True) (Boolean False), Leq (Num 1) (Num 2), Leq (Num 2) (Num 1), IsZero (Num 0), IsZero (Num 1), Fix (Lambda "x" (TNum :->: TNum) (Id "x")), Fix (Lambda "x" (TNum :->: TNum) (Num 1))]
